    ...
    <div class="login-form">
        <div class="main-div">
            ...
            <form method="post" action="">
                <br><br><br><br>
                <br>
                <div class="container" style="width: 30%; margin: auto; background-color: white;">
                    <br>
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #d38038c8; width: 80%; margin-left: 10%; margin-top:5%; border: 1px #80da62;" name="submit">Login</button>
                    <br><br>
                </div>
            </form>
        </div>
